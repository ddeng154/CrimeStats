...
class CompareCrimes extends React.Component {
    ...
    handleSubmit() {
        ...
        if (this.state.id1 && this.state.id2) {
            ...
            axios.all<AxiosResponse<CrimeData>>([request1, request2]).then(axios.spread((response1, response2) => {
                this.setState({
                    ...
                    <table className="table">
                        <thead>
                            <tr>
                                ...
                                <th>
                                    <a href={"/crimes/" + this.state.element1!.id}>{ this.state.element1!.type} in {this.state.element1!.pd_name }</a>
                                </th>
                                <th>
                                    <a href={"/crimes/" + this.state.element2!.id}>{ this.state.element2!.type} in {this.state.element2!.pd_name }</a>
                                </th>
                            </tr>
                        </thead>
                        <tbody>
