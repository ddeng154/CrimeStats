...
class CompareCounties extends React.Component {
    ...
    handleSubmit() {
        ...
        if (this.state.id1 && this.state.id2) {
            ...
            axios.all<AxiosResponse<CountyData>>([request1, request2]).then(axios.spread((response1, response2) => {
                this.setState({
                    ...
                    <table className="table">
                        <thead>
                            <tr>
                                ...
                                <th>
                                    <a href={"/counties/" + this.state.element1!.id}>{this.state.element1!.name}</a>
                                </th>
                                <th>
                                    <a href={"/counties/" + this.state.element2!.id}>{this.state.element2!.name}</a>
                                </th>
                            </tr>
                        </thead>
                        <tbody>
