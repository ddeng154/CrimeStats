            ...
            <tbody>
              ...
              {/* if county has PDs, show them */}
              {
                ...
                <tr>
                  ...
                  <td> 
                    <ul>{ this.state.county.police_departments.map
                    (pd => <Nav.Link key={pd.ori} href={"/policedepartments/" + 
                    pd.ori}>{pd.name}</Nav.Link>) }</ul> 
                  </td>
                </tr>
              }
              {/* if county has crimes, show them */}
              {
                ...
                <tr>
                  ...
                  <td> 
                    <ul>{ this.state.county.crimes.map(
                      c => <Nav.Link key={c.id} href={"/crimes/" + 
                      c.id}>{c.type} in {c.pd_name}</Nav.Link>) }</ul> 
                  </td>
                </tr>
              }
            </tbody>
              ...
              {/* display pie chart of demographics of county pop. */}
                ...
                <label style={{color:"#E38627", fontSize:"28px"}}>
                  ...
                  {(this.state.county.black_pop / 
                    this.state.county.total_pop * 100).toFixed(2)}%</label>
                <br />
