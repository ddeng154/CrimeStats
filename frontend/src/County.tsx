          ...
          <Container fluid>
            <div className="d-flex justify-content-between">
              ...
              <Col>
                ...
                <label style={{color:"#E38627", fontSize:"28px"}}>Black Population: 
                  {(this.state.county.black_pop / this.state.county.total_pop * 100).toFixed(2)}%</label>
                <br />
                <label style={{color:"#C13C37", fontSize:"28px"}}>White Population: 
                  {(this.state.county.white_pop / this.state.county.total_pop * 100).toFixed(2)}%</label>
                <br />
                <label style={{color:"#6A2135", fontSize:"28px"}}>Pacific Population: 
                  {(this.state.county.pacific_pop / this.state.county.total_pop * 100).toFixed(2)}%</label>
                <br />
                <label style={{color:"#2757E3", fontSize:"28px"}}>Native Population: 
                  {(this.state.county.native_pop / this.state.county.total_pop * 100).toFixed(2)}%</label>
                <br />
                <label style={{color:"#E327B7", fontSize:"28px"}}>Asian Population: 
                  {(this.state.county.asian_pop / this.state.county.total_pop * 100).toFixed(2)}%</label>
              </Col>
              <Col>
                <PieChart
                    animate
